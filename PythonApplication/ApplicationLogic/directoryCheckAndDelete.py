...
def check_dir():
    ...
    output_exist=os.path.join(curr_dir, "Output")
    ...
    if audio_exist == False:
        path = os.path.join(os.path.join(curr_dir,"Output","Audio"))
        os.mkdir(path)
    ...
    if screenshots_exist == False:
        path = os.path.join(os.path.join(curr_dir,"Output","Screenshots"))
        os.mkdir(path)
